<template>
    ...
    <div class="grid md:grid-cols-3 gap-6 mb-12">
        ...
        <div class="border rounded-lg p-6">
            ...
            <p class="text-gray-600">
                Save time by automatically checking answers, calculating scores,
                and providing immediate feedback when needed.
            </p>
        </div>
        ...
        <div class="border rounded-lg p-6">
            ...
            <p class="text-gray-600">
                Store previous attempts, scores, and results to follow progress
